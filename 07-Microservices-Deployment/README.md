...
| ------------------------------- | --------------------------------------------- |
| User Management Microservice | nholuongut/usermanagement-microservice:1.0.0 |
| Notifications Microservice | nholuongut/notifications-microservice:1.0.0 |
...
- **DNS register the LB URL** with a custom domain name something like "services.nholuongut.com" in Route53. 
    - Gather the DNS Name of "microservices-alb"
    - Create a Record set in Hosted Zone
        - Record Set Name: services.nholuongut.com
        - Alias: Yes
...
- **Configure Container Definition**    
    ...
    - Image: nholuongut/notifications-microservice:1.0.0
    - Container Port: 8096
    - Environment Variables
        - AWS_MAIL_SERVER_HOST=email-smtp.us-east-1.amazonaws.com
        - AWS_MAIL_SERVER_USERNAME=*****
...
```
http://services.nholuongut.com/notification/health-status
```
...
- **Configure Container Definition**
    ...
    - Image: nholuongut/usermanagement-microservice:1.0.0
    - Container Port: 8095
    - **Environment Variables**
        - AWS_RDS_HOSTNAME=microservicesdb.cxojydmxwly6.us-east-1.rds.amazonaws.com
        - AWS_RDS_PORT=3306
        ...
        - AWS_RDS_USERNAME=dbadmin
        - AWS_RDS_PASSWORD=*****
        - NOTIFICATION_SERVICE_HOST=services.nholuongut.com [or] ALB DNS Name
...
- Verify using Load Balancer URL or DNS registered URL
```
http://services.nholuongut.com/usermgmt/health-status
```
...
- Add environment url 
    - http://services.nholuongut.com (**Replace with your ALB DNS registered url on your environment**)
