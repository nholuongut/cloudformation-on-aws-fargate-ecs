package com.nholuongut.usermanagement.core.controllers;
...
import com.nholuongut.usermanagement.core.dtos.EmailMessage;
import com.nholuongut.usermanagement.core.entities.User;
import com.nholuongut.usermanagement.core.repositories.UserRepository;
...
public class UserController {
    ...
    public void sendAccountActivationNotifications(User user) {
        ...
        String userEmailContent = String.format("Hello %s, your Nho Luong DevOps Blogs account is created successfully!", user.getFirstname());

		EmailMessage message = new EmailMessage();
		message.setSubject("Nho Luong DevOps Blogs account creation.");
